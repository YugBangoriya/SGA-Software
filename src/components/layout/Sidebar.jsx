...
//
// FIX (Phase 9 Bug 1):
//   Added "reminders: Bell" to ICON_MAP (now in src/lib/iconMap.js).
//
// FIX (Phase 11 — dual ICON_MAP consolidation):
//   Replaced the local ICON_MAP object with a shared import from
//   src/lib/iconMap.js. More.jsx has been updated identically.
//   When a new nav item is added to rbac.js, update iconMap.js once.
