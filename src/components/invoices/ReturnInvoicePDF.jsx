...
import { formatCurrency, formatDate, DEFAULT_TERMS } from "../../lib/invoiceHelpers";
...
const styles = StyleSheet.create({
  ...
  returnBadge: {
    ...
    padding: "3 8", marginTop: 4, alignSelf: "flex-end",
  },
  ...
  infoPanel: {
    flex: 1, backgroundColor: C.cardBg, borderRadius: 6,
  ...
  totalsSection: {
    ...
    marginTop: 0, borderTopWidth: 2, borderTopColor: C.primary,
  },
  ...
  termsSection: {
    marginTop: 16, padding: 12, backgroundColor: C.cardBg,
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.headerRow}>
          ...
          <View style={styles.invoiceTitleBox}>
            ...
            <Text style={styles.invoiceDateRow}>Date: {formatDate(invoice.returnDate || invoice.invoiceDate)}</Text>
          </View>
        </View>

        {/* ── RETURN NOTICE ── */}
        <View style={styles.returnNotice}>
          <Text style={styles.returnNoticeText}>⚠  This is a return / refund invoice. Items have been returned to stock.</Text>
        </View>
        ...
        <View style={styles.infoRow}>
          ...
          <View style={styles.infoPanel}>
            ...
            <View style={styles.infoLine}>
              ...
              <Text style={styles.infoValue}>{formatDate(invoice.returnDate || invoice.invoiceDate)}</Text>
            </View>
            <View style={styles.infoLine}>
        ...
        <View style={styles.totalsSection}>
          <View style={styles.totalsBox}>
            ...
            <View style={[styles.totalLine, { marginTop: 4 }]}>
              ...
              <Text style={[styles.totalValue, { color: C.amber, fontFamily: "Courier-Bold" }]}>{formatCurrency(totalReturnAmount)}</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.signatureSection}>
          ...
          <View style={styles.signatureBox}>
            <View style={styles.signatureLine} />
            <Text style={styles.signatureLabel}>Authorised Signatory{"\n"}Shree Ganesh Automobile</Text>
          </View>
        </View>
