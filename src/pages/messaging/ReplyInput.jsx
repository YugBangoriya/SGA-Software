...
export default function ReplyInput() {
  ...
  const handleSend = useCallback(async () => {
    ...
    // sendReply now handles its own toast on error and returns false on failure.
    // We catch here as a secondary safety net for unexpected JS errors.
    try {
  ...
  }, [replyDraft, sendingMessage, activeConversationId, sendReply, currentUser, toast]);
